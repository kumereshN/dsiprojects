...
Here is the link on [markdown cheatsheet](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) that can be used to create good README.md
...
**Materials must be submitted by the beginning of class (9AM) on Nov 9th.**
